...
namespace WebThuVien.Areas.Admin.Controllers
{
    public class NhaXuatBansController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "ID_NXB,TenNXB,DiaChiNXB,SDT_NXB,Email_NXB")] NhaXuatBan nhaXuatBan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_NXB,TenNXB,DiaChiNXB,SDT_NXB,Email_NXB")] NhaXuatBan nhaXuatBan)
        {
            if (ModelState.IsValid)
            {
