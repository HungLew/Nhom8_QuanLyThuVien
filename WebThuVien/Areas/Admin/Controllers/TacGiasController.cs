...
namespace WebThuVien.Areas.Admin.Controllers
{
    public class TacGiasController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "ID_TacGia,HotenTG,NgaySinh,QuocTich,GioiThieu")] TacGia tacGia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_TacGia,HotenTG,NgaySinh,QuocTich,GioiThieu")] TacGia tacGia)
        {
            if (ModelState.IsValid)
            {
